...
class RegistroActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        ...
        val url = "http://192.168.1.242/android_mysql1/consulta.php?id=$id"
...
//ELIMINA USUARIOS
    fun eliminar(Vista: View){
        val url = "http://192.168.1.242/android_mysql1/borrar.php"
        procesoEnCola= Volley.newRequestQueue(this)
    ...
    fun editar(Vista: View){
        val url = "http://192.168.1.242/android_mysql1/editar.php"
        procesoEnCola = Volley.newRequestQueue(this)
